...
class _ReceivemsgState extends State<Receivemsg> {
  final listMsg=FirebaseFirestore.instance.collection('message').orderBy("date").snapshots();
        ...
        children: [
          Align(
            ...
            child: Padding(
              ...
              child: Text("Messages",
              style: TextStyle(color:Color(0xFF16056B),fontSize:30,fontWeight: FontWeight.bold ),),
            ),
          ),
          SizedBox(
            height: 15,
       ...
       Container(
        child: Row(
          children: [
            ...
            Text("search",style: TextStyle(fontSize: 15,color: Color(0xFF4B4646)),),
            Spacer(flex: 1,),
            Padding(
              padding: const EdgeInsets.only(right:8.0),
              child: Icon
              (Icons.filter_list,size: 25,color:Color(0xFF4B4646)),
            )
          ],
        ),
        height: 38,
               ...
               child: Column(
                ...
                child: Stack(
                  ...
                  trailing: InkWell(
                      ...
                      child: Icon(Icons.delete,color: Color(0xFF16056B),),
                    ),
                    ),
                    ],
                ),
